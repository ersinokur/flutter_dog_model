...
// and add an arbitrary shadow for styling.
      decoration: BoxDecoration(
        ...
        // boxshadow for yhe right look so the
        // bpxshadow property takes a list of boxhadows.
        boxShadow: [
          const BoxShadow(
              // just like CSS:
  ...
  Widget get rating {
//use a row to lay widgets horizantally.
    return Row(
      //center the widgets on the main-axis
      //which is the horizantal axis in a row.
